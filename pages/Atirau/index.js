  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name='description' content='Мы устанавливаем и изготавливаем окна в Атырау на заказ уже более 20 лет. Нас ценят за надежность и качество. Мы работаем всегда в срок, без простоев.' />
        <title>Установка и производство  окон в Атырау </title>
      </Head>
